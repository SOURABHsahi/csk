...
export default function KarmaHistory() {
    ...
    // Mock data based directly on PRD 5.13 rules
    const activities = [
    ...
    // Mock Top 10 Leaderboard (FR-KP-02, FR-KP-03)
    const leaderboard = [
        { rank: 1, name: 'Sourabh Sahu', role: 'Staff Engineer', points: 6420, avatar: 'https://randomuser.me/api/portraits/men/22.jpg' },
        { rank: 2, name: 'Meghna Tiwari', role: 'Design Lead', points: 5150, avatar: 'https://randomuser.me/api/portraits/women/44.jpg' },
        { rank: 3, name: 'Vishendra Sharma', role: 'DevOps Architect', points: 4890, avatar: 'https://randomuser.me/api/portraits/men/11.jpg' },
        { rank: 4, name: 'Rishikesh Ugle', role: 'Product Manager', points: 3200, avatar: 'https://randomuser.me/api/portraits/men/33.jpg' },
        { rank: 5, name: 'Loveneesh Sharma', role: 'System Admin', points: 2800, avatar: 'https://randomuser.me/api/portraits/men/55.jpg' },
        { rank: 6, name: 'Mayur Verma', role: 'Tech Lead', points: 1950, avatar: 'https://randomuser.me/api/portraits/men/66.jpg' },
        { rank: 7, name: 'Aditi Sharma', role: 'HR Specialist', points: 1250, avatar: 'https://randomuser.me/api/portraits/women/12.jpg' }, // Current user
        { rank: 8, name: 'Rahul Kumar', role: 'Developer', points: 890, avatar: 'https://randomuser.me/api/portraits/men/82.jpg' },
        { rank: 9, name: 'Priya Singh', role: 'Security', points: 600, avatar: 'https://randomuser.me/api/portraits/women/33.jpg' },
        { rank: 10, name: 'Amit Patel', role: 'Data Scientist', points: 150, avatar: 'https://randomuser.me/api/portraits/men/91.jpg' },
    ];
                ...
                <div className="lg:col-span-2 glass card-lift bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 p-8 shadow-sm relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="flex items-baseline gap-4 mb-2">
                            <h1 className="text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-yellow-500 to-amber-600">1,250</h1>
                    ...
                    <table className="w-full text-left border-collapse min-w-[700px]">
                        ...
                        <tbody className="divide-y divide-slate-100 dark:divide-slate-800/50">
                            {leaderboard.map((user) => {
                                ...
                                const isCurrentUser = user.rank === 7; // Highlight Aditi Sharma
                                return (
