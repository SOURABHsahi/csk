...
export async function getVideos() {
    try {
        ...
        return data.map(v => ({
            ...
            thumbnail: v.thumbnailUrl ? (v.thumbnailUrl.startsWith('http') ? v.thumbnailUrl : `${API_BASE}${v.thumbnailUrl}`) : 'https://images.unsplash.com/photo-1540317580384-e5d43616b9aa?auto=format&fit=crop&q=80&w=1200&h=600',
