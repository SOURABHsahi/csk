...
public class ArticleService : IArticleService
{
    ...
    public async Task<ArticleDetailDto> CreateArticleAsync(int currentUserId, CreateArticleDto dto)
    {
        ...
        await _karmaService.AwardKarmaAsync(currentUserId, KarmaActivityTypes.CreateArticle, KarmaPoints.CreateArticlePoints, ContentTypes.Article, saved.ArticleId);
