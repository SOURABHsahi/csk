...
public class PodcastService : IPodcastService
{
    ...
    public async Task<PodcastDto> CreatePodcastAsync(int currentUserId, CreatePodcastDto dto)
    {
        ...
        await _karmaService.AwardKarmaAsync(currentUserId, KarmaActivityTypes.CreatePodcast, KarmaPoints.CreatePodcastPoints, ContentTypes.Podcast, saved.PodcastId);
